...
STRING_SESSION = os.environ.get("STRING_SESSION", "-1002488326553")


# Log & Force Channel Config
FORCE_SUBS = os.environ.get("FORCE_SUBS", "Movie_Centre1")
LOG_CHANNEL = int(os.environ.get("LOG_CHANNEL", "-1002488326553"))
...
DATABASE_NAME = os.environ.get("DATABASE_NAME", "Movie_group_ut_bot")
