...
DATABASE_URL = os.environ.get("DATABASE_URL", "mongodb+srv://Utkarsh123:<db_password>@utkarsh9.af91n.mongodb.net/?retryWrites=true&w=majority&appName=Utkarsh9")
DATABASE_NAME = os.environ.get("DATABASE_NAME", "Utkarsh9")
